    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AuthorId = table.Column<string>(type: "character varying(7)", maxLength: 7, nullable: false),
                    LastName = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    MiddelName = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PubId = table.Column<string>(type: "character varying(7)", maxLength: 7, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RoleId = table.Column<string>(type: "character varying(7)", maxLength: 7, nullable: false),
                    RoleDesc = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookId = table.Column<string>(type: "character varying(7)", maxLength: 7, nullable: false),
                    ...
                    YtdSales = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<string>(type: "character varying(7)", maxLength: 7, nullable: false),
                    EmailAddress = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AuthorId = table.Column<string>(type: "character varying(7)", maxLength: 7, nullable: false),
                    BookId = table.Column<string>(type: "character varying(7)", maxLength: 7, nullable: false),
                    AuthorOrder = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    RoyaltyPercentage = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
